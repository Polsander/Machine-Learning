...
def predict(X, W1, b1, W2, b2, W3, b3):
    A1 = calculate_a(X, W1, b1)
    A2 = calculate_a(A1, W2, b2)
    A3 = calculate_a(A2, W3, b3)
...
if __name__ == "__main__":
    ...
    # temp = (210 - min_temp)/(max_temp - min_temp)
    # time = (12 - min_time) / (max_time - min_time)
    ...
    X_new = np.array([[time, temp]]) # MUST NORMALIZE!!!
